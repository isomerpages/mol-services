...
housing-options:
  ...
  - title: <a name="sales"></a>Get updates on HDB Sales launches
    content: |
...
eligibility-checker:
  ...
  - title: How to improve chances with HDB Priority Schemes (new flats only)
    content: | 
  ...
  - title: No time to read? Use this checker
    content: |
...
housing-finances:
  ...
  - title: Contra Payment Facility
    content: |
      You can consider [Contra Payment Facility](https://hdb.gov.sg/cs/infoweb/residential/financing-a-flat-purchase/housing-loan-from-hdb/contra-payment-facility-for-new-flats){:target="_blank"} if you are buying a new flat and own another existing HDB flat. This can help you to:
  ...
  - title: <a name="grants"></a>CPF housing grants
    content: |
      You may receive subsidies of up to $80,000 in the form of the [CPF Housing Grants](https://www.hdb.gov.sg/cs/infoweb/residential/buying-a-flat/new/schemes-and-grants/cpf-housing-grants-for-hdb-flats/firsttimer-applicants){:target="_blank"}. You can apply at <a href="/government-services/buying-a-hdb/book-flat/" target="_blank">your appointment with HDB</a> if you are eligible.
  - title: Financing your flat with CPF
    content: |
      ...
      These tools can help you in your planning:
...
related-housing-content:
  - title: Housing payments as an HDB owner
    content: |
...
---------------------------------------
## <a name="top"></a>I Want to Move Home
...
### <a name="housing-types"></a>Decide if you want to buy from HDB or resale market
...
### <a name="new"></a>Apply for a flat from HDB

{% include buying-process.html %}

### <a name="buy-resale"></a>Buy an HDB resale flat
